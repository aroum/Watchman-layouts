...
[1] = LAYOUT(
LGUI_T(KC_CAPS), KC_PAST, KC_7, KC_8, KC_9, KC_PPLS,     KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, RGUI_T(KC_F1), 
...
[3] = LAYOUT(
LGUI_T(KC_NLCK), RESET,   KC_P7, KC_P8, KC_P9, KC_INS,         KC_F8,   KC_F9,   KC_F10,  RGB_TOG, RESET,  GUI_T(KC_SLCK), 
