...
[1] = LAYOUT(
KC_NO, LGUI_T(KC_F1),   KC_F2,   KC_F3, KC_F4,   KC_F5,  KC_F6,     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  RGUI_T(KC_F12), KC_NO,
...
[2] = LAYOUT(
KC_NO, LGUI_T(KC_NLCK), KC_PSLS, KC_P7, KC_P8, KC_P9, TO(3),       KC_WH_U, KC_HOME, KC_MPLY, KC_PGUP, KC_VOLU, RGUI_T(KC_CAPS), KC_NO,
...
[3] = LAYOUT(
KC_NO, LGUI_T(KC_SLCK), RGB_VAI, KC_BTN1, KC_MS_U, KC_BTN2, KC_WH_U,       KC_WH_U, KC_BTN1, KC_MS_U, KC_BTN2, BL_INC,  KC_RGUI, KC_NO,
